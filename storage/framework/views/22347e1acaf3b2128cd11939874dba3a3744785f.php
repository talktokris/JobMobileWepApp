        ...
        <div class="user-box dropdown">
            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button"
                ...
                <div class="user-info ps-3">
                 ...
                 ?>
                    <p class="designattion mb-0"><?php echo e($roleString); ?></p>
                </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                */ ?>
                ...
                <li><form method="POST" id="log-form" action="<?php echo e(route('logout')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/prabhu_jobs/web-app/job-web-app/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>